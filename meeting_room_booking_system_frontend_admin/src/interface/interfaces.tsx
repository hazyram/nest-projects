...
import { UserInfo } from '../pages/modify_menu/InfoModify'
import { UpdatePassword } from '../pages/modify_menu/PasswordModify'
import { CreateMeetingRoom } from '../pages/meeting_room_manage/CreateMeetingRoomModal'
import { UpdateMeetingRoom } from '../pages/meeting_room_manage/UpdateMeetingRoomModal'
import { SearchBooking } from '../pages/booking_manage/BookingManage'
...
export async function updateMeetingRoomById(meetingRoom: UpdateMeetingRoom) {
